 ...
 *
 * Options:
 *   - `clientID`      identifies client to Gitlab
 ...
 * Examples:
 *
 *     passport.use(new GitLabStragegy({
...
function Strategy(options, verify) {
  ...
  if (!options.customHeaders['User-Agent']) {
    options.customHeaders['User-Agent'] = options.userAgent || 'passport-gitlab';
  ...
  this.name = 'gitlab';
  this._userProfileURL = options.userProfileURL || 'https://gitlab.com/api/v3/user';
